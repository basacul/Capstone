...
# that you have built and to provide an interface that can be accessed by others via a Shiny app..
#
# Tasks to accomplish
#
...
#
# Consider the size of the predictive model you have developed. You may have to sacrifice some accuracy 
# to have a fast enough/small enough model to load into Shiny. 